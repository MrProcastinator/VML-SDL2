...
namespace SDL2
{
	public static class SDL_mixer
	{
		...
		/* Original method: "MIX_Linked_Version" */
		...
		/* Original method: "Mix_GetChunkDecoder" */
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		...
		/* Original method: "Mix_GetMusicDecoder" */
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		 ...
		 */
		/* Original method: "Mix_GetMusicTitle" */
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		 ...
		 * Only available in 2.0.5 or higher.
		 */
		/* Original method: "Mix_GetMusicTitleTag" */
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		 ...
		 * Only available in 2.0.5 or higher.
		 */
		/* Original method: "Mix_GetMusicArtistTag" */
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		 ...
		 * Only available in 2.0.5 or higher.
		 */
		/* Original method: "Mix_GetMusicAlbumTag" */
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		 ...
		 * Only available in 2.0.5 or higher.
		 */
		/* Original method: "Mix_GetMusicCopyrightTag" */
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		...
		/* Original method: "Mix_SetMusicCMD" */
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		...
		/* Original method: "Mix_SetSoundFonts" */
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		...
		/* Original method: "Mix_GetSoundFonts" */
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		...
		/* Only available in 2.0.5 or later. */
		/* Original method: "Mix_GetTimidityCfg" */
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
